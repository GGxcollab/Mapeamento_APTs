...
def load_data_filter():
    df = pd.read_csv("Mapeamento_APTs relacionados bbts.csv", sep=';')
    return(df)
...
with col2:
    st.markdown("<p style='color: yellow; font-size: 60px;'>Grupos Hackers que <br> atacam empresas semelhantes a <br> BBTS .</p>", unsafe_allow_html=True)
